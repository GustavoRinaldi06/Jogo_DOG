...
namespace ObjectFactory
{
    GameObject *CreateHandObject(const tmx::Object &object)
    {
        ...
        DamageObj *damageObj = new DamageObj(*handGO, 10, "recursos/img/sprites/Hand.png", "recursos/audio/Hunter/boing.mp3", "", 8, 1);
    ...
    GameObject *CreateThornObject(const tmx::Object &object)
    {
        ...
        DamageObj *damageObj = new DamageObj(*thornGO, 10, "recursos/img/sprites/Thorn.png", "recursos/audio/Hunter/boing.mp3", "", 8, 1, "Thorn");
    ...
    GameObject *CreateDeerEatingObject(const tmx::Object &object)
    {
        ...
        deer->box.x = object.getPosition().x;
        deer->box.y = object.getPosition().y; // Importante!
        deer->AddComponent(new DeerEating(*deer));
        return deer;
    }
    ...
    GameObject *CreateDeerObject(float x, float y)
    {
        ...
        deer->box.x = x;
        deer->box.y = y + 200;
        deer->AddComponent(new Deer(*deer));
        std::cout << "Deer created at position: " << deer->box.x << ", " << deer->box.y << std::endl;
        return deer;
    }
    ...
    GameObject *CreateDeerObject(const tmx::Object &object)
    {
        GameObject *deer = new GameObject();
        deer->box.x = object.getPosition().x;
        deer->box.y = object.getPosition().y;
        deer->AddComponent(new Deer(*deer));
        return deer;
    }
}